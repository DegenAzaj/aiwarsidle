...
internal static class SimulationFactories
{
    ...
    public static PvpConfig CreatePvpConfig(SimulationVariant variant)
    {
        ...
        cfg.StrategyMultiplierAggressive = 1.05f;
        cfg.StrategyMultiplierStable = 1.00f;
        cfg.StrategyMultiplierRisky = 1.10f;
        cfg.StabilityMultiplierMin = 0.90f;
        cfg.StabilityMultiplierMax = 1.20f;
    ...
    public static MapConfig CreateMapConfig(int radius, int factions)
    {
        ...
        cfg.StabilityGrowthPerSecond = 0.35f;
